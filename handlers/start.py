...
FAQ_BOTS = (
    ...
    "Бот работает исключительно в чатах с темами (топиками). При добавлении "
    "выдай боту права администратора и в разделе «General» (общей теме) "
    "напиши команду <code>/connect</code> — так бот подключится и будет "
    "создавать топики с ПЗ!\n\n"
