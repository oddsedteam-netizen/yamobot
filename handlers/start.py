...
FAQ_BOTS = (
    ...
    "reply-кнопки) и выдаст код вида <code>YM-7F3A-91C2</code> и ссылку "
    "для переноса;\n"
    "• <b>«📥 Внести конфиг»</b> — пришли этот код или ссылку, и настройки "
    "применятся к боту. Статистика, имя и токен бота не меняются.\n"
...
FAQ_PROFILE = (
    ...
    "5. Снять защиту в любой момент: <b>Профиль → 🚨 Антинакрутка → "
    "🔄 Сбросить защиту</b> — уведомления и создание топиков возобновятся.\n\n"
